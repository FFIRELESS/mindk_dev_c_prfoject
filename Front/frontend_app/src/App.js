...
function App() {
  ...
  <div className="App">
    <header className="App-header">
      ...
      <PostContainer postHeader="Ellie from &quot;The Last Of Us&quot; will be filmed in 2022"
                     postImg={<img src={postImg} className="App-postImg" alt="d"/>} postText="it became known
                     ...
                     dangers and opponents." postAuthor="Tokarenko Dmitrii"/>
    </header>
  </div>
  );
}
